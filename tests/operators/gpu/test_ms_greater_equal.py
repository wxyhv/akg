...
import numpy as np
from akg.ops.poly_gpu import greater_equal_manual, greater_equal_auto
...
def test_ms_greater_equal(shape1, shape2, in_dtype, poly_sch=False):
    if poly_sch:
        mod = utils.op_build(greater_equal_auto, (shape1, shape2), (in_dtype, in_dtype),  attrs={"target":"cuda"})
    else:
        mod = utils.op_build(greater_equal_manual, (shape1, shape2), (in_dtype, in_dtype))
