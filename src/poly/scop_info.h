...
class UserConfig {
 public:
  ...
  int GetByPathC1() const { return bypathC1_; }
  ...
  void SetByPassC1(int by_passC1) { this->bypathC1_ = by_passC1; }
...
class ScopInfo {
 public:
  explicit ScopInfo(isl::ctx ctx) : ctx_(ctx), mmu_info_(CubeInfo(user_config_, analysis_result_)) {}
  ~ScopInfo() = default;
